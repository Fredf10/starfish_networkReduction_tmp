...
def initConsts(t=0):
    ...
    p[12] = 220 # max heart rate / could be adjusted for different ages
    p[13] = 35 #minimal heart rate / might be very low, might have to be increased
    p[14] = 0.175
    p[15] = 0
    p[16] = 0.1099
    p[17] = 5
    ...
    p[25] = 60 # background firing rate, estimated with CellML simulation of Bugenhagen
