...
\item We disobey the convention on function names, where PEP 8 wants them to be lowercase and seperated by underscores, we use mixedCase for functions as well.
